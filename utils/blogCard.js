  ...
  if (dark === true) {
    ...
    <foreignObject
          ...
          <p
            ...
            xlink:href="#blogName"
            style="color:#F5F5F5;font-family:Helvetica;font-size:20px;font-weight:bold;margin:0;padding:0;font-weight=bold"
            letter-spacing="0em"
            >${title}
            </p>
    </foreignObject>
    <text fill="#AEAEAE"  font-family="Helvetica" font-size="14" font-weight="bold" letter-spacing="0em"><tspan x="16" y="215">${hostname}</tspan></text>
    <foreignObject
          x="16" y=${coverImage !== "" ? `"370"` : `"225"`} width="260" height="120">
          <p
            xmlns="http://www.w3.org/1999/xhtml"
            xlink:href="#blogName"
            style="color:#AEAEAE;font-family:Helvetica;font-size:14px;margin:0;padding:0;font-weight=bold"
            letter-spacing="0em"
            >${brief}
            </p>
    </foreignObject>
